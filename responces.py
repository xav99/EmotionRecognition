...
class Commands:
	...
	afternoonCom = ["afternoon", "goodafternoon", "evening"]
	nightCom = ["night", "goodnight"]
	
	# rude command
	rudeCom = ["stupid", "asshole", "useless", "worthless", "dumb", "shit", "ass", "go away", "trash", "fuck", "fuk", "idiot", "arsehole", "bitch", "s***", "f***", "cunt","c***", "hell", "bullshit", "bulls***"]
	
	# interactions
	question = ["what", "whats", "what's", "who", "whos", "who's", "when", "whens", "when's", "is", "how", "hows", "how's"]
	confirm = ["yes", "yea", "yeah", "ya", "ok", "cool", "nice", "yep", "awesome", "sweet", "smile"]
	unconfirm = ["no", "na", "nah", "nar", "dont", "don't", "not", "wasn't"]
